...
class customer_limit_wizard(models.TransientModel):
    ...
    def action_create_activity(self):
        for record in self:
            ...
            summary = 'El pedido ha sido bloqueado por superar La cartera, por favor revisar'
    ...
    credit_limit = fields.Float(related='partner_id.credit_limit',string="Portfolio Limit")
